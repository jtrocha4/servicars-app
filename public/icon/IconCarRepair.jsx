...
const IconCarRepair = ({ width = 40, className, fill = '#000000' }) => {
  return (
    <>
      <svg className={className} fill={fill} width={`${width}px`} viewBox='0 0 15 15' xmlns='http://www.w3.org/2000/svg' id='icon-car-repair'>
